...
var _qrcodePng = require("./qrcode.png");
var _qrcodePngDefault = parcelHelpers.interopDefault(_qrcodePng);
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    if (isMobile) {
        ...
        const qrCodeAndroid = createQrCodeContainer((0, _qrcodePngDefault.default), "Scan to download Lingui on Android", "Android");
        const qrCodeIos = createQrCodeContainer((0, _qrcodePngDefault.default), "Scan to download Lingui on iOS", "iOS");
    ...
    (0, _gsap.gsap).from(heroText, {
        opacity: 0,
        y: -50,
        duration: 1.5,
        ease: "power3.out"
    });
    (0, _gsap.gsap).utils.toArray(".testimonial-card").forEach((card)=>{
        (0, _gsap.gsap).fromTo(card, {
            opacity: 0.5,
            x: -200
        }, {
            opacity: 1,
    ...
    (0, _gsap.gsap).utils.toArray(".benefit-item").forEach((item)=>{
...
},{"alpinejs":"69hXP","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./qrcode.png":"lTDNL","gsap/ScrollTrigger":"7wnFk"}],"69hXP":[function(require,module,exports) {
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lTDNL":[function(require,module,exports) {
module.exports = require("a40df9a2d6e908c2").getBundleURL("3gKDs") + "qrcode.ad00e31f.png" + "?" + Date.now();

},{"a40df9a2d6e908c2":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DoTH","adjPd"], "adjPd", "parcelRequire0aac")
